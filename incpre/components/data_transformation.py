...
from incpre.utils import save_object

@dataclass
class DataTransfromartionConfigs:
    preprocess_obj_file_patrh = os.path.join("artifact/data_transformation", "preprcessor.pkl")
...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            #transfpormation on train data and test data
            ...
            #preprocessor object on train data and test data
...
#     train_arr, test_arr , _ = data_transformation.inititate_data_transformation(train_path, test_path)